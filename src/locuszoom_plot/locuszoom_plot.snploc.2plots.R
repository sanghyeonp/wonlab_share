...
parser$add_argument("--pos-col-snploc", dest="pos.snploc", required=T,
                    help="Specify POS column name of snploc file.")
...
parser$add_argument("--gene-track-off", dest="gene_track_off", action="store_true", default=F,
                    help="Specify to avoid plotting the gene track. Default=FALSE.")
