...
tryCatch({
    ...
    ### Outcome liftover merge
    parser$add_argument("--lifted-file", dest="lifted_file", required=FALSE, default='NA', 
                        help="Specify path for the lifted outcome.")
    parser$add_argument("--lifted-snp-col", dest="lifted_snp_col", required=FALSE, default='NA', 
                        help="Specify .")
    parser$add_argument("--lifted-chr-col", dest="lifted_chr_col", required=FALSE, default='NA', 
                        help="Specify .")
    parser$add_argument("--lifted-pos-col", dest="lifted_pos_col", required=FALSE, default='NA', 
                        help="Specify .")

    ### Exposure filter
    parser$add_argument("--iv-list-path", dest="iv_list_path", required=TRUE,
                        help="Specify the path that contains a list of IV to select.")
    parser$add_argument("--iv-exp-p-thres", dest="iv_exp_p_thres", required=FALSE, default=1e-5, type='double',
                        help="Specify the P-value threshold of specified IV in exposure GWAS.")
    ...
    iv_list_path <- args$iv_list_path
    ...
    lifted_file <- args$lifted_file
    lifted_snp_col <- args$lifted_snp_col
    lifted_chr_col <- args$lifted_chr_col
    lifted_pos_col <- args$lifted_pos_col
    ...
    foreach (idx=1:nrow(df_combined), .combine=c) %dopar% {
        ...
        run_iv_specified_tsmr(exposure_gwas, exposure_delim, 
                                ...
                                lifted_snp_col=lifted_snp_col,
                                lifted_chr_col=lifted_chr_col,
                                lifted_pos_col=lifted_pos_col)
